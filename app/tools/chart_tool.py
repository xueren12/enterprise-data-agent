...
CHART_CONFIGS = {
    "department_failure_rate": {
        "x": "department",
        "y": "failure_rate",
        "title": "Department API Failure Rate",
        "xlabel": "Department",
        "ylabel": "Failure Rate (%)",
        "type": "bar",
    },
    ...
    "department_call_volume": {
        "x": "department",
        "y": "total_calls",
        "title": "Department API Call Volume",
        "xlabel": "Department",
        "ylabel": "Calls",
        "type": "bar",
    },
    "department_call_volume_trend": {
        "x": "date",
        "y": "total_calls",
        "title": "Department API Call Volume Trend",
        "xlabel": "Date",
        "ylabel": "Calls",
        "type": "multi_line",
    },
